...
public class RandomInputsGenerator {
	...
	public static void main(String args[]) {
		...
		*/
		int freqAbaixo75, freq75Mais, nota1Baixa, nota1BaixaMenor30, nota1Alta, nota2Baixa, 
			nota2BaixaMenor30, nota2Alta, notaFinalBaixa, notaFinalAlta;
		...
		nota1BaixaMenor30 = generateRandomNumberInRange(29,0);
		...
		nota2BaixaMenor30 = generateRandomNumberInRange(29,0);
		writeInFile(nota2BaixaMenor30);
		
		nota2Alta = generateRandomNumberInRange(100,70);
		writeInFile(nota2Alta);
		
		notaFinalBaixa = generateRandomNumberInRange(69,0);
